...
import com.example.basicvideocapturer.VonageVideoConfig.description
import com.example.basicvideocapturer.VonageVideoConfig.isValid
...
class MainActivity : ComponentActivity() {
    ...
    private fun finishWithMessage(message: String) {
        Log.e(com.example.basicvideocapturer.MainActivity.Companion.TAG, message)
